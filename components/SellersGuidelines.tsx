        ...
        content: (
            <div>
                ...
                <div className="mb-4">
                    ...
                    <p className="text-[#0B0E0C]/50 mb-4">
                        1. Once your item reaches its new home, and we have had confirmation of this, you will receive your payment within 2 working days
                    </p>
                    <p className="text-[#0B0E0C]/50">
                        2. Payments will be made only after we receive confirmation that the
                        items have been delivered in good condition. Klick Africa will make payments to you net of our 12.5% commission.
                        In case, any item sold by you does not match its listing description or images, no payment
                        can be made and you will be required to bear the full cost of return and transport cost.
                    </p>
                </div>
            </div>
        ),
